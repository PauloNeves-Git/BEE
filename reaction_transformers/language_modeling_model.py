...
from language_modeling_utils import SimpleDataset, mask_tokens
...
from utilities.file_utils import WEIGHTS_NAME
from utilities.optimization import AdamW
from transformers import AutoConfig, AutoTokenizer, AutoModelWithLMHead, BertConfig, BertForMaskedLM, BertTokenizer, get_linear_schedule_with_warmup

from language_modeling_utils import TextDataset, LineByLineTextDataset
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if self.args["model_name"]:
            self.model = model_class.from_pretrained(model_name, config=self.config, cache_dir=self.args["cache_dir"], **kwargs)
        else:
